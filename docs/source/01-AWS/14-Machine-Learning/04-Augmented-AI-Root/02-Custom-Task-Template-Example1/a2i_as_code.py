...
def start_human_loop():
    task_json = Path(dir_here, "task.json").read_text(encoding="utf-8")
    input_content = json.loads(task_json)
...
if __name__ == "__main__":
    ...
    start_human_loop()
    # describe_human_loop(id="46a45b79-7edf-4f09-8ae8-9a29357e62c6")
    pass
